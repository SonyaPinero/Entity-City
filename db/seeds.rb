...
Story.create({
	title: "The Morris-Jumel Mansion",
...
Story.create({
	title: "12 Gay Street",
	content: "Located right around the corner from bustling Sixth Avenue, Gay Street is arguably one of the most picturesque blocks in New York, and the quaint brick townhouse at number 12 is no exception. The building served as a speakeasy called The Pirate’s Den during Prohibition and was purchased by the corrupt (yet wildly popular) Mayor Jimmy Walker as a home for his mistress, Ziegfeld girl Betty Compton. Neighbors insist that ghostly flappers and the Gay Street Phantom—a dapper gent in a cloak and top hat—still lurk around late at night, and if that’s not creepy enough, the property was later bought by Frank Paris, the creator of notorious hell-puppet Howdy Doody.",
	address: "12 Gay Street, New York, NY 10014",
	neighborhood_id: 69
})

Story.create({
	title: "St. Mark's Church in-the-Bowery",
	content: "St. Mark’s Chruch in-the-Bowery is the second-oldest church in Manhattan, splitting from Trinity Church in 1799. Built on Dutch colonial governor Peter Stuyvesant’s family farm, legend has it that the cantankerous, peg-legged Dutchman still haunts the area. He’s been known to harass clergymen and parishioners, ring the bells, and loudly interrupt services by stomping around and singing Calvinist hymns in Dutch. Apparently, English Episcopal hymns simply don’t agree with him.",
